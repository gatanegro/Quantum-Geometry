...
class QuantumCalculatorApp:
    ...
    def setup_ui(self):
        ...
        format_label = ttk.Label(main_frame, 
                               text="Use format: 1.616255e-35 or 2 (integers work too!)",
    ...
    def safe_float_convert(self, value_str):
        """Safely convert string to float, handling scientific notation and integers"""
        try:
            # Handle empty string
            ...
            raise ValueError(f"Cannot convert '{value_str}' to float. Use format: 1.616255e-35 or 2")
